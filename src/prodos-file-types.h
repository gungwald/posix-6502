...
#define PRODOS_FILE_TYPE_OVL    0xF1    /* User defined 1               */
...
*/
#define PRODOS_TXT_AUX_TYPE_SEQ         0x0000  /* Sequential text  */

/* 8IC auxiliary type */
#define PRODOS_8IC_AUX_TYPE_APEX        0x8003  /* Apex program     */

/* GWP auxiliary types */
#define PRODOS_GWP_AUX_TYPE_TEACH       0x5445  /* Teach            */
#define PRODOS_GWP_AUX_TYPE_DELUXEWRITE 0x8001  /* DeluxeWrite      */
#define PRODOS_GWP_AUX_TYPE_APLWRKSGS   0x8010  /* AppleWorks GS    */

/* GSS auxiliary type */
#define PRODOS_GSS_AUX_TYPE_APLWRKSGS   0x8010  /* AppleWorks GS    */
